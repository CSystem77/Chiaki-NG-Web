...
An experimental **WebAssembly** (browser) client lives in `wasm/`. It runs `chiaki-lib` in the page and uses a local Node.js UDP/TCP proxy. See [wasm/README.md](wasm/README.md) and [docs/diy/buildwasm.md](docs/diy/buildwasm.md).
